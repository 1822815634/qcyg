...
+(void)GetImageViewWithUrl:(NSString *)ImageUrl BlockSuccess:(void (^)(UIImage *))success{
    
    SDWebImageManager *manager = [SDWebImageManager sharedManager];
    [manager loadImageWithURL:[NSURL URLWithString:ImageUrl] options:(SDWebImageOptions)SDWebImageAllowInvalidSSLCertificates progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
