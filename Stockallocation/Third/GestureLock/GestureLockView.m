...
-(instancetype)initWithFrame:(CGRect)frame hiddenBottom:(BOOL)hidden bottomBtnTag:(int)tag{
    if (self=[super initWithFrame:frame]) {
        ...
        btn.frame = CGRectMake(0, kScreenHeight - kTabbarHeight - 50 -20, kScreenWidth, 20);
        [btn setTitle:!tag?@"忘记手势密码":@"跳过,暂不设置" forState:UIControlStateNormal];
...
- (void)btnClick:(UIButton *)btn {
    switch (btn.tag) {
        case 0: {
            ...
            [[NSUserDefaults standardUserDefaults]setBool:0 forKey:GestureTag];
