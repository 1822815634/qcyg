...
- (instancetype)initWithTextField:(UITextField *)textField {
    if (self = [super init]) {
        ...
        self.verify = true;
        self.layer.borderColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:247/255.0 alpha:1].CGColor;
...
- (void)setupKeyBoard {
  ...
  UIButton * confirmbutton=[UIButton buttonWithType:UIButtonTypeSystem];
    ...
    UIView *topLineView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, keyboardScreenWidth, 1)];
    topLineView.backgroundColor = [UIColor colorWithRed:246/255.0 green:246/255.0 blue:247/255.0 alpha:1];
